(function($) {
    ...
    ParseRESTAPIKey = "IYkecC2bwjTYy4suhkGTEn7yrJaLC7ygVc5Esedd";
  ...
  */
    $.each(['GET', 'POST', 'PUT', 'DELETE'], function(i, action) {
        ...
        methods[m] = function() {
			...
			if(typeof GLOBAL.noACL == 'undefined') {
				
				if(m === "put" || m === "post") {
					data.ACL = {};
					data.ACL[GLOBAL.userid] = { "read": true, "write": true };
					data.ACL["role:Administrators"] = { "read": true, "write": true };
				}
			} else {
				delete GLOBAL.noACL;
			}
